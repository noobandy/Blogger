...
<body>
	<div class="welcome">
		...
		<h1> Hello World !!! ...You have arrived.</h1>
		<hr/>
		<form name="greetingForm" method="post" action="<?php echo(URL::to('/greet')); ?>">
			<input required="required" type="text" name="name" placeholder="Who are you?"/>
